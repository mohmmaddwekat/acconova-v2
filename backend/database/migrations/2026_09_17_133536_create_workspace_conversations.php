...
return new class extends Migration
{
    ...
    {
        Schema::create('workspace_conversations', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('workspace_conversation_members', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('workspace_messages', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(['conversation_id', 'user_id', 'request_id'], 'workspace_message_request_unique');
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('workspace_conversation_members');
