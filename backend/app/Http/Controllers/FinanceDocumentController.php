...
class FinanceDocumentController extends Controller
{
    ...
    private function validatedDocument(Request $request, ?string $forcedKind = null): array
    {
        $data = $request->validate([
            ...
            'seller_tax_snapshot' => ['nullable', 'array'],
            'seller_tax_snapshot.name' => ['nullable', 'string', 'max:180'],
            'seller_tax_snapshot.tax_number' => ['nullable', 'string', 'max:100'],
            'seller_tax_snapshot.registration_number' => ['nullable', 'string', 'max:100'],
            'seller_tax_snapshot.address' => ['nullable', 'string', 'max:255'],
            'seller_tax_snapshot.city' => ['nullable', 'string', 'max:100'],
            'seller_tax_snapshot.region' => ['nullable', 'string', 'max:100'],
            'seller_tax_snapshot.country' => ['nullable', 'string', 'max:100'],
            'seller_tax_snapshot.phone' => ['nullable', 'string', 'max:60'],
            'seller_tax_snapshot.email' => ['nullable', 'email', 'max:180'],
            'seller_tax_snapshot.website' => ['nullable', 'string', 'max:255'],
            'buyer_tax_snapshot' => ['nullable', 'array'],
            'buyer_tax_snapshot.name' => ['nullable', 'string', 'max:180'],
            'buyer_tax_snapshot.tax_number' => ['nullable', 'string', 'max:100'],
            'buyer_tax_snapshot.registration_number' => ['nullable', 'string', 'max:100'],
            'buyer_tax_snapshot.address' => ['nullable', 'string', 'max:255'],
            'buyer_tax_snapshot.city' => ['nullable', 'string', 'max:100'],
            'buyer_tax_snapshot.region' => ['nullable', 'string', 'max:100'],
            'buyer_tax_snapshot.country' => ['nullable', 'string', 'max:100'],
            'buyer_tax_snapshot.phone' => ['nullable', 'string', 'max:60'],
            'buyer_tax_snapshot.email' => ['nullable', 'email', 'max:180'],
            'buyer_tax_snapshot.website' => ['nullable', 'string', 'max:255'],
    ...
    private function detail(FinancialDocument $document, FinanceDocumentService $service): array
    {
        return [
            ...
            'party_detail' => $document->party ? [
                ...
                'address_line_1' => $document->party->address_line_1,
                'address_line_2' => $document->party->address_line_2,
                'city' => $document->party->city,
                'postal_code' => $document->party->postal_code,
