...
const columnLabels: Record<string, [string, string]> = {
    ...
    month: ['الشهر', 'Month'],
    current_0_30: ['حالي / حتى 30 يوم', 'Current / 0–30 days'],
    days_31_60: ['31–60 يوم', '31–60 days'],
    days_61_90: ['61–90 يوم', '61–90 days'],
    over_90: ['أكثر من 90 يوم', '90+ days'],
    total_outstanding: ['إجمالي الذمم المستحقة', 'Total outstanding'],
