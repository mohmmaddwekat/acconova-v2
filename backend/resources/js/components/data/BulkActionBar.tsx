...
export function BulkActionBar({
    ...
    return (
        <div
            className="fixed bottom-4 start-3 end-3 z-[110] sm:start-1/2 sm:end-auto sm:w-[min(620px,calc(100vw-3rem))] sm:-translate-x-1/2 rtl:sm:translate-x-1/2"
            style={{
                bottom:
            ...
            <div className="grid gap-3 rounded-[20px] border border-white/10 bg-[var(--ac-text)] p-3 text-white shadow-[0_20px_70px_rgba(18,30,25,0.28)] sm:grid-cols-[1fr_auto] sm:items-center sm:p-3.5">
                <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        >
                            {allPageSelected
                                ? t('ui.unselect_this_page')
                                : t('ui.select_this_page')}
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_auto] gap-2">
                    ...
                    <button
                        type="button"
                        aria-label={t('ui.clear_selection')}
                        onClick={
                            onClear
                        }
