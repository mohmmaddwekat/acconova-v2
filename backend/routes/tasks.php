...
Route::middleware(['auth', 'verified', ResolveOrganization::class])->group(function (): void {
    ...
    Route::get('/app/task-management/teams/{team}/create', [TaskManagementController::class, 'page'])->whereNumber('team')->defaults('view', 'teams-create')->name('tasks.teams.subteams.create');
    ...
    Route::prefix('api/task-management')->group(function (): void {
        ...
        Route::get('/search', [TaskManagementController::class, 'index']);
